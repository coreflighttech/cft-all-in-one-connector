...
namespace MobiFlight
{
    ...
    {
        // Dedicated identity: intentionally different from the standard MobiFlight mutex
        // so both applications can run side by side.
        static Mutex mutex = new Mutex(true, "{8D92BF1C-7B12-4C7E-96FA-CORENAV737001}");
        /// <summary>
